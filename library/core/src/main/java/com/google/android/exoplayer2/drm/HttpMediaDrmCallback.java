...
public final class HttpMediaDrmCallback implements MediaDrmCallback {
    //add our own Drm callback
    public static interface DrmStartCallback {
        void onStart();
    }
    ...
    private DrmStartCallback drmStartCallback;
    ...
    public HttpMediaDrmCallback(String defaultLicenseUrl, boolean forceDefaultLicenseUrl,
                                HttpDataSource.Factory dataSourceFactory, DrmStartCallback drmStartCallback) {
        this.dataSourceFactory = dataSourceFactory;
        this.defaultLicenseUrl = defaultLicenseUrl;
        this.forceDefaultLicenseUrl = forceDefaultLicenseUrl;
        this.keyRequestProperties = new HashMap<>();
        this.drmStartCallback = drmStartCallback;
    }
